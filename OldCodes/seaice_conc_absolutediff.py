...
del data
abs_diff_ESACCI_SSMI_NH = np.mean(conc, axis=0)
...
m.pcolormesh(lon, lat, abs_diff_ESACCI_SSMI_NH,
...
del data
abs_diff_NSIDC0051_NH = np.mean(conc, axis=0) - abs_diff_ESACCI_SSMI_NH
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
image=m.pcolormesh(lon, lat, abs_diff_NSIDC0051_NH,
             latlon=True, cmap='RdBu_r')
plt.clim(-10, 10)
plt.title("NSIDC0051")
...
conc = data.variables['siconc'][156:360]
del data
abs_diff_OSISAF409a_NH = np.mean(conc, axis=0) - abs_diff_ESACCI_SSMI_NH
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, abs_diff_OSISAF409a_NH,
             latlon=True, cmap='RdBu_r')
plt.clim(-10, 10)
...
del data
abs_diff_OSISAF450_NH = np.mean(conc, axis=0) - abs_diff_ESACCI_SSMI_NH
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, abs_diff_OSISAF450_NH,
             latlon=True, cmap='RdBu_r')
plt.clim(-10, 10)
plt.title("OSISAF450")
...
del data
abs_diff_NSIDC_G02202_v3_NH = np.mean(conc, axis=0) - abs_diff_ESACCI_SSMI_NH
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, abs_diff_NSIDC_G02202_v3_NH,
             latlon=True, cmap='RdBu_r')
plt.clim(-10, 10)
...
del data
abs_diff_ICDC_ASI_SSMI_NH = np.mean(conc, axis=0) - abs_diff_ESACCI_SSMI_NH
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, abs_diff_ICDC_ASI_SSMI_NH,
             latlon=True, cmap='RdBu_r')
plt.clim(-10, 10)
...
del data
abs_diff_Hadisst1_NH = np.mean(conc, axis=0) - abs_diff_ESACCI_SSMI_NH
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, abs_diff_Hadisst1_NH,
             latlon=True, cmap='RdBu_r')
plt.clim(-10, 10)
plt.title("Hadisst1")
...
del data
abs_diff_Hadisst2_NH = np.mean(conc, axis=0) - abs_diff_ESACCI_SSMI_NH
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, abs_diff_Hadisst2_NH,
             latlon=True, cmap='RdBu_r')
plt.clim(-10, 10)
plt.title("Hadisst2")
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
image2=m.pcolormesh(lon, lat, abs_diff_ESACCI_SSMI_NH,
...
plt.suptitle("Sea-Ice Concentration - Absolute Differences as compared to ESACCI_SSMI (1992-2007) - Northern Hemisphere")
fig.savefig('/home/elic/arunr/git/UCL_BE_AR/Diagnostics/Results/Sea-Ice_Conc_AD_nh.eps', format='eps')
fig.savefig('/home/elic/arunr/git/UCL_BE_AR/Diagnostics/Results/Sea-Ice_Conc_AD_nh.pdf', format='pdf')
plt.close(fig)
...
conc = data.variables['siconc'][:]
del data
abs_diff_ESACCI_SSMI_SH = np.mean(conc, axis=0)
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, abs_diff_ESACCI_SSMI_SH,
             latlon=True, cmap='RdBu_r')
plt.clim(0, 100)
plt.title("ESACCI_SSMI")
...
conc = data.variables['siconc'][156:360]
del data
abs_diff_NSIDC0051_SH = np.mean(conc, axis=0) - abs_diff_ESACCI_SSMI_SH
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
image=m.pcolormesh(lon, lat, abs_diff_NSIDC0051_SH,
             latlon=True, cmap='RdBu_r')
plt.clim(-10, 10)
plt.title("NSIDC0051")
...
conc = data.variables['siconc'][156:360]
del data
abs_diff_OSISAF409a_SH = np.mean(conc, axis=0) - abs_diff_ESACCI_SSMI_SH
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, abs_diff_OSISAF409a_SH,
             latlon=True, cmap='RdBu_r')
plt.clim(-10, 10)
plt.title("OSISAF409a")
...
conc = data.variables['siconc'][24:228]
del data
abs_diff_OSISAF450_SH = np.mean(conc, axis=0) - abs_diff_ESACCI_SSMI_SH
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, abs_diff_OSISAF450_SH,
             latlon=True, cmap='RdBu_r')
plt.clim(-10, 10)
plt.title("OSISAF450")
...
conc = data.variables['siconc'][36:240]
del data
abs_diff_NSIDC_G02202_v3_SH = np.mean(conc, axis=0) - abs_diff_ESACCI_SSMI_SH
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, abs_diff_NSIDC_G02202_v3_SH,
             latlon=True, cmap='RdBu_r')
plt.clim(-10, 10)
plt.title("NSIDC_G02202_v3")
...
conc = data.variables['siconc'][0:204]
del data
abs_diff_ICDC_ASI_SSMI_SH = np.mean(conc, axis=0) - abs_diff_ESACCI_SSMI_SH
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, abs_diff_ICDC_ASI_SSMI_SH,
             latlon=True, cmap='RdBu_r')
plt.clim(-10, 10)
plt.title("ICDC_ASI_SSMI")
...
conc = data.variables['siconc'][1464:1668]
del data
abs_diff_Hadisst1_SH = np.mean(conc, axis=0) - abs_diff_ESACCI_SSMI_SH
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, abs_diff_Hadisst1_SH,
             latlon=True, cmap='RdBu_r')
plt.clim(-10, 10)
plt.title("Hadisst1")
...
conc = data.variables['siconc'][1704:1908]
del data
abs_diff_Hadisst2_SH = np.mean(conc, axis=0) - abs_diff_ESACCI_SSMI_SH
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, abs_diff_Hadisst2_SH,
             latlon=True, cmap='RdBu_r')
plt.clim(-10, 10)
plt.title("Hadisst2")
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
image2=m.pcolormesh(lon, lat, abs_diff_ESACCI_SSMI_SH,
             latlon=True, cmap='Blues_r')
plt.clim(0, 100)
plt.title("ESACCI_SSMI")
cax2 = fig.add_axes([0.7, 0.075, 0.175, 0.02])
...
cax = fig.add_axes([0.93, 0.2, 0.02, 0.6])
plt.colorbar(image, cax, orientation='vertical')
plt.suptitle("Sea-Ice Concentration - Absolute Differences as compared to ESACCI_SSMI (1992-2007) - Southern Hemisphere")
fig.savefig('/home/elic/arunr/git/UCL_BE_AR/Diagnostics/Results/Sea-Ice_Conc_AD_sh.eps', format='eps')
fig.savefig('/home/elic/arunr/git/UCL_BE_AR/Diagnostics/Results/Sea-Ice_Conc_AD_sh.pdf', format='pdf')
plt.close(fig)
