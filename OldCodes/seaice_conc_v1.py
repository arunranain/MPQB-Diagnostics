...
del data
average_conc_NSIDC0051_NH = np.mean(conc, axis=0)
...
image=m.pcolormesh(lon, lat, average_conc_NSIDC0051_NH,
...
conc = data.variables['siconc'][156:360]
del data
average_conc_OSISAF409a_NH = np.mean(conc, axis=0)
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, average_conc_OSISAF409a_NH,
             latlon=True, cmap='Blues_r')
plt.clim(0, 100)
...
del data
average_conc_OSISAF450_NH = np.mean(conc, axis=0)
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, average_conc_OSISAF450_NH,
             latlon=True, cmap='Blues_r')
plt.clim(0, 100)
plt.title("OSISAF450")
...
del data
average_conc_NSIDC_G02202_v3_NH = np.mean(conc, axis=0)
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, average_conc_NSIDC_G02202_v3_NH,
             latlon=True, cmap='Blues_r')
plt.clim(0, 100)
...
del data
average_conc_ICDC_ASI_SSMI_NH = np.mean(conc, axis=0)
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, average_conc_ICDC_ASI_SSMI_NH,
             latlon=True, cmap='Blues_r')
plt.clim(0, 100)
...
del data
average_conc_Hadisst1_NH = np.mean(conc, axis=0)
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, average_conc_Hadisst1_NH,
             latlon=True, cmap='Blues_r')
plt.clim(0, 100)
plt.title("Hadisst1")
...
del data
average_conc_Hadisst2_NH = np.mean(conc, axis=0)
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, average_conc_Hadisst2_NH,
             latlon=True, cmap='Blues_r')
plt.clim(0, 100)
plt.title("Hadisst2")
...
plt.suptitle("Sea-Ice Concentration - Northern Hemisphere (1992-2007)")
fig.savefig('/home/elic/arunr/git/UCL_BE_AR/Diagnostics/Results/Sea-Ice_Conc_Average_nh.eps', format='eps')
fig.savefig('/home/elic/arunr/git/UCL_BE_AR/Diagnostics/Results/Sea-Ice_Conc_Average_nh.pdf', format='pdf')
plt.close(fig)
...
conc = data.variables['siconc'][156:360]
del data
average_conc_NSIDC0051_SH = np.mean(conc, axis=0)
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
image=m.pcolormesh(lon, lat, average_conc_NSIDC0051_SH,
             latlon=True, cmap='Blues_r')
plt.clim(0, 100)
plt.title("NSIDC0051")
...
conc = data.variables['siconc'][156:360]
del data
average_conc_OSISAF409a_SH = np.mean(conc, axis=0)
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, average_conc_OSISAF409a_SH,
             latlon=True, cmap='Blues_r')
plt.clim(0, 100)
plt.title("OSISAF409a")
...
conc = data.variables['siconc'][24:228]
del data
average_conc_OSISAF450_SH = np.mean(conc, axis=0)
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, average_conc_OSISAF450_SH,
             latlon=True, cmap='Blues_r')
plt.clim(0, 100)
plt.title("OSISAF450")
...
conc = data.variables['siconc'][36:240]
del data
average_conc_NSIDC_G02202_v3_SH = np.mean(conc, axis=0)
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, average_conc_NSIDC_G02202_v3_SH,
             latlon=True, cmap='Blues_r')
plt.clim(0, 100)
plt.title("NSIDC_G02202_v3")
...
conc = data.variables['siconc'][0:204]
del data
average_conc_ICDC_ASI_SSMI_SH = np.mean(conc, axis=0)
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, average_conc_ICDC_ASI_SSMI_SH,
             latlon=True, cmap='Blues_r')
plt.clim(0, 100)
plt.title("ICDC_ASI_SSMI")
...
conc = data.variables['siconc'][1464:1668]
del data
average_conc_Hadisst1_SH = np.mean(conc, axis=0)
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, average_conc_Hadisst1_SH,
             latlon=True, cmap='Blues_r')
plt.clim(0, 100)
plt.title("Hadisst1")
...
conc = data.variables['siconc'][1704:1908]
del data
average_conc_Hadisst2_SH = np.mean(conc, axis=0)
...
m.drawparallels(np.arange(-80.,81.,20.), labels=[1,0,0,0] )
m.drawmeridians(np.arange(-180.,181.,20.), labels=[0,1,0,0] )
m.pcolormesh(lon, lat, average_conc_Hadisst2_SH,
             latlon=True, cmap='Blues_r')
plt.clim(0, 100)
plt.title("Hadisst2")
...
cax = fig.add_axes([0.9, 0.2, 0.02, 0.6])
plt.colorbar(image, cax, orientation='vertical')
plt.suptitle("Sea-Ice Concentration - Southern Hemisphere (1992-2007)")
fig.savefig('/home/elic/arunr/git/UCL_BE_AR/Diagnostics/Results/Sea-Ice_Conc_Average_sh.eps', format='eps')
fig.savefig('/home/elic/arunr/git/UCL_BE_AR/Diagnostics/Results/Sea-Ice_Conc_Average_sh.pdf', format='pdf')
plt.close(fig)
